  ...
  _createClass(ValidatedForm, [{
    ...
    value: function onSubmit(fieldValues) {
      ...
      (0, _when2.default)(fieldValues).then(function (data) {
        ...
        }).omitBy(_lodash2.default.isEmpty).value();
    ...
    value: function fill() {
      ...
      (_refs$form = this.refs.form).fill.apply(_refs$form, arguments);
    }
  }, {
    key: 'doSubmit',
    value: function doSubmit() {
      ...
      (_refs$form2 = this.refs.form).doSubmit.apply(_refs$form2, arguments);
    }
  }, {
    key: 'onClear',
    value: function onClear() {
      ...
      (_refs$form3 = this.refs.form).onClear.apply(_refs$form3, arguments);
    }
  }]);
